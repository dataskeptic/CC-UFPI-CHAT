...
/* stBottom transparent — grid shows through */
...
/* ── Global font + text color (does NOT touch avatar containers) ── */
html, body,
...
/* ── Avatar icons — undo any color/bg overrides ── */
...
/* Streamlit wraps avatars in .stChatMessageAvatarUser / ...AvatarAssistant */
[class*="stChatMessageAvatar"],
[class*="stChatMessageAvatar"] * {
    color: unset !important;
...
/* ── Badge ── */
.badge-wrap { display: flex; justify-content: center; margin-bottom: 2.4rem; }
.badge {
    display: inline-flex; align-items: center;
    border: 1px solid #C4BFB5; border-radius: 999px;
    background: #F4F1EA; overflow: hidden;
    font-size: 0.76rem; box-shadow: 0 1px 4px rgba(0,0,0,0.08);
}
.badge-label { padding: 0.3rem 0.9rem; color: #6B6459 !important; font-weight: 400; }
.badge-cta {
    padding: 0.3rem 0.9rem; background: #1A1816;
    color: #F4F1EA !important; font-weight: 500;
...
.hero h1 {
    ...
    color: #1A1816 !important; margin: 0 0 1.1rem;
    letter-spacing: -0.01em;
}
.hero h1 em { font-style: italic; color: #3D3830 !important; }
.hero .sub {
    font-size: 0.93rem; color: #857E74 !important;
...
/* Nuke inner divs (NOT textarea/button/svg) */
[data-testid="stChatInput"] div,
[data-testid="stChatInput"] span:not([data-testid]) {
    background: transparent !important;
    border: none !important;
    box-shadow: none !important;
...
/* Send button — ghost, just the arrow */
...
[data-testid="stChatInput"] button:hover {
    background: rgba(62,201,122,0.1) !important;
    opacity: 1;
}
...
.tag {
    font-size: 0.75rem; color: #5A5650 !important;
    padding: 0.35rem 0.85rem;
    border: 1px solid #C0BAB0; border-radius: 5px;
    background: rgba(244,241,234,0.8);
    cursor: default; font-family: 'DM Sans', sans-serif !important;
}
...
/* Do NOT override span inside messages — avatars use spans */
...
[data-testid="stExpander"] [data-testid="stMarkdownContainer"] span { color: #2A2720 !important; }
